...
const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-br from-darkText to-darkText/90 text-white py-12">
      <div className="container mx-auto px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            {/* Brand Section */}
            <div>
              <h3 className="text-2xl font-bold font-poppins mb-3 bg-gradient-to-r from-secondary to-primary bg-clip-text text-transparent">
                ...
                {['Home', 'About', 'Skills', 'Projects', 'Timeline', 'Contact'].map((item) => (
                  <li key={item}>
                    <a
                      ...
                      className="text-gray-300 hover:text-secondary font-inter text-sm transition-colors duration-300 hover:translate-x-1 inline-block"
                    >
                      {item}
                    </a>
                  </li>
            ...
            {/* Connect */}
            <div>
              <h4 className="text-lg font-bold font-poppins mb-4">Connect With Me</h4>
